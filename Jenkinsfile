node('master') {
    try {
        stage('build') {
            ...
            bat 'docker run --rm --volume //c/Users/ACER/git/TestProjectCloverLaravel:/app composer self-update --stable --no-ansi'
        ...
        stage('test') {
            ...
            bat 'docker run --rm --name phpunit-container -v //c/Users/ACER/git/TestProjectCloverLaravel:/usr/src/app -w /usr/src/app php:7.2-cli php ./vendor/bin/phpunit'
        }
